...
__global__ void vector_add(double *a, double *b, double *c)
{
    ...
    // index = soma do indice do bloco (qual bloco é) * tamanho desse bloco + o indice da thread para conseguir chegar ao sitio de guardar
    //calcular o id da thread a partir do id do bloco e a posicao do bloco na grid
...
int main()
{
    ...
    // NUMBER_BLOCKS = N + (THREADS_PER_BLOCK-1))/ THREADS_PER_BLOCK = 1024
    /*
    myKernel<<< B, T >>>(arg1, … );
